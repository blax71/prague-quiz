const CACHE = 'prague-quiz-v2';
const ASSETS = ['./','./index.html','./style.css','./app.js','./manifest.json','./assets/jocke-start.jpg','./icons/icon-180.png','./icons/icon-192.png','./icons/icon-512.png'];
